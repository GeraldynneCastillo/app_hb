...
# Configuración LDAP (Al final del archivo settings.py)
LDAP_CONFIG = {
    'HOST': 'cmfad1',           # Servidor de la CMF
    'PORT': 389,
    'BASE_DN': 'DC=cmf,DC=cl',
    'USER_DN': 'totem@cmf.cl',  # Usuario de servicio
    'PASSWORD': 'Martina_0390.-', # Contraseña (según tu archivo anterior)
}